...
execute unless score @s bbl.move.mouse_angle.pitch.current = @s bbl.move.mouse_angle.pitch.past run function bb:internal/systems/move_detector/mouse_move
execute unless score @s bbl.move.mouse_angle.yaw.current = @s bbl.move.mouse_angle.yaw.past run function bb:internal/systems/move_detector/mouse_move
