...
execute if score @s bbl.xp.success matches 1 if score $minuslevel bbl.xp matches 0..16 run function bb:internal/systems/minuslevels/low
execute if score @s bbl.xp.success matches 1 if score $minuslevel bbl.xp matches 17..31 run function bb:internal/systems/minuslevels/mid
execute if score @s bbl.xp.success matches 1 if score $minuslevel bbl.xp matches 32.. run function bb:internal/systems/minuslevels/high
