...
function bb:internal/systems/string_manip/compile_metadata/reset_character_array
execute if data storage bb:lib sudo_root.parsing.array[0] run function bb:internal/systems/string_manip/compile_metadata/recurse_compile
