...
#Concat line
function bb:internal/systems/string_manip/concat/build with storage bbl:concat sudo_root.internal.build

#If done, spit out result
execute unless data storage bbl:concat sudo_root.internal.queue[0] run function bb:internal/systems/string_manip/concat/finish
#If remaing characters, loop
execute if data storage bbl:concat sudo_root.internal.queue[0] run function bb:internal/systems/string_manip/concat/loop
